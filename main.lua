...
function init()
  ...
  get_character_stat_string = function(character, level)
    local group = Group():set_as_physics_world(
      32,
      0,
      0,
      { "player", "enemy", "projectile", "enemy_projectile" }
    )
    local player = Player({
      group = group,
      leader = true,
    ...
    return "[red]HP: [red]"
      ...
      .. player.dmg
      .. "[fg], [green]ASPD: [green]"
      .. math.round(player.aspd_m, 2)
      .. "x[fg], [blue]AREA: [blue]"
      .. math.round(player.area_dmg_m * player.area_size_m, 2)
      .. "x[fg], [yellow]DEF: [yellow]"
      .. math.round(player.def, 2)
      .. "[fg], [green]MVSPD: [green]"
      .. math.round(player.v, 2)
      .. "[fg]"
  end
  ...
  character_descriptions = {
    ["vagrant"] = function(lvl)
      return "[fg]shoots a projectile that deals [yellow]"
        .. get_character_stat("vagrant", lvl, "dmg")
        .. "[fg] damage"
    end,
    ["swordsman"] = function(lvl)
      return "[fg]deals [yellow]"
        .. get_character_stat("swordsman", lvl, "dmg")
        .. "[fg] damage in an area, deals extra [yellow]"
        .. math.round(get_character_stat("swordsman", lvl, "dmg") * 0.15, 2)
        .. "[fg] damage per unit hit"
    end,
    ["wizard"] = function(lvl)
      return "[fg]shoots a projectile that deals [yellow]"
        .. get_character_stat("wizard", lvl, "dmg")
        .. " AoE[fg] damage"
    end,
    ["magician"] = function(lvl)
      return "[fg]creates a small area that deals [yellow]"
        .. get_character_stat("magician", lvl, "dmg")
        .. " AoE[fg] damage"
    end,
    ["archer"] = function(lvl)
      return "[fg]shoots an arrow that deals [yellow]"
        .. get_character_stat("archer", lvl, "dmg")
        .. "[fg] damage and pierces"
    end,
    ["scout"] = function(lvl)
      return "[fg]throws a knife that deals [yellow]"
        .. get_character_stat("scout", lvl, "dmg")
        .. "[fg] damage and chains [yellow]3[fg] times"
    end,
    ["cleric"] = function(lvl)
      return "[fg]creates [yellow]1[fg] healing orb every [yellow]8[fg] seconds"
    end,
    ["outlaw"] = function(lvl)
      return "[fg]throws a fan of [yellow]5[fg] knives, each dealing [yellow]"
        .. get_character_stat("outlaw", lvl, "dmg")
        .. "[fg] damage"
    end,
    ["blade"] = function(lvl)
      return "[fg]throws multiple blades that deal [yellow]"
        .. get_character_stat("blade", lvl, "dmg")
        .. " AoE[fg] damage"
    end,
    ["elementor"] = function(lvl)
      return "[fg]deals [yellow]"
        .. get_character_stat("elementor", lvl, "dmg")
        .. " AoE[fg] damage in a large area centered on a random target"
    end,
    ["saboteur"] = function(lvl)
      return "[fg]calls [yellow]2[fg] saboteurs to seek targets and deal [yellow]"
        .. get_character_stat("saboteur", lvl, "dmg")
        .. " AoE[fg] damage"
    end,
    ["bomber"] = function(lvl)
      return "[fg]plants a bomb, when it explodes it deals [yellow]"
        .. 2 * get_character_stat("bomber", lvl, "dmg")
        .. " AoE[fg] damage"
    end,
    ["stormweaver"] = function(lvl)
      return "[fg]infuses projectiles with chain lightning that deals [yellow]20%[fg] damage to [yellow]2[fg] enemies"
    end,
    ["sage"] = function(lvl)
      return "[fg]shoots a slow projectile that draws enemies in"
    end,
    ["squire"] = function(lvl)
      return "[yellow]+20%[fg] damage and defense to all allies"
    end,
    ["cannoneer"] = function(lvl)
      return "[fg]shoots a projectile that deals [yellow]"
        .. 2 * get_character_stat("cannoneer", lvl, "dmg")
        .. " AoE[fg] damage"
    end,
    ["dual_gunner"] = function(lvl)
      return "[fg]shoots two parallel projectiles, each dealing [yellow]"
        .. get_character_stat("dual_gunner", lvl, "dmg")
        .. "[fg] damage"
    end,
    ["hunter"] = function(lvl)
      return "[fg]shoots an arrow that deals [yellow]"
        .. get_character_stat("hunter", lvl, "dmg")
        .. "[fg] damage and has a [yellow]20%[fg] chance to summon a pet"
    end,
    ["sentry"] = function(lvl)
      return "[fg]spawns a rotating turret that shoots [yellow]4[fg] projectiles, each dealing [yellow]"
        .. get_character_stat("sentry", lvl, "dmg")
        .. "[fg] damage"
    end,
    ["chronomancer"] = function(lvl)
      return "[yellow]+20%[fg] attack speed to all allies"
    end,
    ["spellblade"] = function(lvl)
      return "[fg]throws knives that deal [yellow]"
        .. get_character_stat("spellblade", lvl, "dmg")
        .. "[fg] damage, pierce and spiral outwards"
    end,
    ["psykeeper"] = function(lvl)
      return "[fg]creates [yellow]3[fg] healing orbs every time the psykeeper takes [yellow]25%[fg] of its max HP in damage"
    end,
    ["engineer"] = function(lvl)
      return "[fg]drops turrets that shoot bursts of projectiles, each dealing [yellow]"
        .. get_character_stat("engineer", lvl, "dmg")
        .. "[fg] damage"
    end,
    ["plague_doctor"] = function(lvl)
      return "[fg]creates an area that deals [yellow]"
        .. get_character_stat("plague_doctor", lvl, "dmg")
        .. "[fg] damage per second"
    end,
    ["barbarian"] = function(lvl)
      return "[fg]deals [yellow]"
        .. get_character_stat("barbarian", lvl, "dmg")
        .. "[fg] AoE damage and stuns enemies hit for [yellow]4[fg] seconds"
    end,
    ["juggernaut"] = function(lvl)
      return "[fg]deals [yellow]"
        .. get_character_stat("juggernaut", lvl, "dmg")
        .. "[fg] AoE damage and pushes enemies away with a strong force"
    end,
    ["lich"] = function(lvl)
      return "[fg]launches a slow projectile that jumps [yellow]7[fg] times, dealing [yellow]"
        .. 2 * get_character_stat("lich", lvl, "dmg")
        .. "[fg] damage per hit"
    end,
    ["cryomancer"] = function(lvl)
      return "[fg]nearby enemies take [yellow]"
        .. get_character_stat("cryomancer", lvl, "dmg")
        .. "[fg] damage per second"
    end,
    ["pyromancer"] = function(lvl)
      return "[fg]nearby enemies take [yellow]"
        .. get_character_stat("pyromancer", lvl, "dmg")
        .. "[fg] damage per second"
    end,
    ["corruptor"] = function(lvl)
      return "[fg]shoots an arrow that deals [yellow]"
        .. get_character_stat("corruptor", lvl, "dmg")
        .. "[fg] damage, spawn [yellow]3[fg] critters if it kills"
    end,
    ["beastmaster"] = function(lvl)
      return "[fg]throws a knife that deals [yellow]"
        .. get_character_stat("beastmaster", lvl, "dmg")
        .. "[fg] damage, spawn [yellow]2[fg] critters if it crits"
    end,
    ["launcher"] = function(lvl)
      return "[fg]all nearby enemies are pushed after [yellow]4[fg] seconds, taking [yellow]"
        .. 2 * get_character_stat("launcher", lvl, "dmg")
        .. "[fg] damage on wall hit"
    end,
    ["jester"] = function(lvl)
      return "[fg]curses [yellow]6[fg] nearby enemies for [yellow]6[fg] seconds, they will explode into [yellow]4[fg] knives on death"
    end,
    ["assassin"] = function(lvl)
      return "[fg]throws a piercing knife that deals [yellow]"
        .. get_character_stat("assassin", lvl, "dmg")
        .. "[fg] damage + [yellow]"
        .. get_character_stat("assassin", lvl, "dmg") / 2
        .. "[fg] damage per second"
    end,
    ["host"] = function(lvl)
      return "[fg]periodically spawn [yellow]1[fg] small critter"
    end,
    ["carver"] = function(lvl)
      return "[fg]carves a statue that creates [yellow]1[fg] healing orb every [yellow]6[fg] seconds"
    end,
    ["bane"] = function(lvl)
      return "[fg]curses [yellow]6[fg] nearby enemies for [yellow]6[fg] seconds, they will create small void rifts on death"
    end,
    ["psykino"] = function(lvl)
      return "[fg]pulls enemies together for [yellow]2[fg] seconds"
    end,
    ["barrager"] = function(lvl)
      return "[fg]shoots a barrage of [yellow]3[fg] arrows, each dealing [yellow]"
        .. get_character_stat("barrager", lvl, "dmg")
        .. "[fg] damage and pushing enemies"
    end,
    ["highlander"] = function(lvl)
      return "[fg]deals [yellow]"
        .. 5 * get_character_stat("highlander", lvl, "dmg")
        .. "[fg] AoE damage"
    end,
    ["fairy"] = function(lvl)
      return "[fg]creates [yellow]1[fg] healing orb and grants [yellow]1[fg] unit [yellow]+100%[fg] attack speed for [yellow]6[fg] seconds"
    end,
    ["priest"] = function(lvl)
      return "[fg]creates [yellow]3[fg] healing orbs every [yellow]12[fg] seconds"
    end,
    ["infestor"] = function(lvl)
      return "[fg]curses [yellow]8[fg] nearby enemies for [yellow]6[fg] seconds, they will release [yellow]2[fg] critters on death"
    end,
    ["flagellant"] = function(lvl)
      return "[fg]deals [yellow]"
        .. 2 * get_character_stat("flagellant", lvl, "dmg")
        .. "[fg] damage to self and grants [yellow]+4%[fg] damage to all allies per cast"
    end,
    ["arcanist"] = function(lvl)
      return "[fg]launches a slow moving orb that launches projectiles, each dealing [yellow]"
        .. get_character_stat("arcanist", lvl, "dmg")
        .. "[fg] damage"
    end,
    ["illusionist"] = function(lvl)
      return "[fg]launches a projectile that deals [yellow]"
        .. get_character_stat("illusionist", lvl, "dmg")
        .. "[fg] damage and creates copies that do the same"
    end,
    ["artificer"] = function(lvl)
      return "[fg]spawns an automaton that shoots a projectile that deals [yellow]"
        .. get_character_stat("artificer", lvl, "dmg")
        .. "[fg] damage"
    end,
    ["witch"] = function(lvl)
      return "[fg]creates an area that ricochets and deals [yellow]"
        .. get_character_stat("witch", lvl, "dmg")
        .. "[fg] damage per second"
    end,
    ["silencer"] = function(lvl)
      return "[fg]curses [yellow]5[fg] nearby enemies for [yellow]6[fg] seconds, preventing them from using special attacks"
    end,
    ["vulcanist"] = function(lvl)
      return "[fg]creates a volcano that explodes the nearby area [yellow]4[fg] times, dealing [yellow]"
        .. get_character_stat("vulcanist", lvl, "dmg")
        .. " AoE [fg]damage"
    end,
    ["warden"] = function(lvl)
      return "[fg]creates a force field around a random unit that prevents enemies from entering"
    end,
    ["psychic"] = function(lvl)
      return "[fg]creates a small area that deals [yellow]"
        .. get_character_stat("psychic", lvl, "dmg")
        .. " AoE[fg] damage"
    end,
    ["miner"] = function(lvl)
      return "[fg]picking up gold releases [yellow]4[fg] homing projectiles that each deal [yellow]"
        .. get_character_stat("miner", lvl, "dmg")
        .. " [fg]damage"
    end,
    ["merchant"] = function(lvl)
      return "[fg]gain [yellow]+1[fg] interest for every [yellow]10[fg] gold, up to a max of [yellow]+10[fg] from the merchant"
    end,
    ["usurer"] = function(lvl)
      return "[fg]curses [yellow]3[fg] nearby enemies indefinitely with debt, dealing [yellow]"
        .. get_character_stat("usurer", lvl, "dmg")
        .. "[fg] damage per second"
    end,
    ["gambler"] = function(lvl)
      return "[fg]deal [yellow]2X[fg] damage to a single random enemy where X is how much gold you have"
    end,
    ["thief"] = function(lvl)
      return "[fg]throws a knife that deals [yellow]"
        .. 2 * get_character_stat("thief", lvl, "dmg")
        .. "[fg] damage and chains [yellow]5[fg] times"
    end,
  }
  ...
  character_effect_descriptions = {
    ["vagrant"] = function()
      return "[yellow]+15%[fg] attack speed and damage per active class"
    end,
    ["swordsman"] = function()
      return "[fg]the swordsman's damage is [yellow]doubled"
    end,
    ["wizard"] = function()
      return "[fg]the projectile chains [yellow]2[fg] times"
    end,
    ["magician"] = function()
      return "[yellow]+50%[[fg] attack speed every [yellow]12[fg] seconds for [yellow]6[fg] seconds"
    end,
    ["archer"] = function()
      return "[fg]the arrow ricochets off walls [yellow]3[fg] times"
    end,
    ["scout"] = function()
      return "[yellow]+25%[fg] damage per chain and [yellow]+3[fg] chains"
    end,
    ["cleric"] = function()
      return "[fg]creates [yellow]4[fg] healing orbs every [yellow]8[fg] seconds"
    end,
    ["outlaw"] = function()
      return "[yellow]+50%[fg] outlaw attack speed and his knives seek enemies"
    end,
    ["blade"] = function()
      return "[fg]deal additional [yellow]"
        .. math.round(get_character_stat("blade", 3, "dmg") / 3, 2)
        .. "[fg] damage per enemy hit"
    end,
    ["elementor"] = function()
      return "[fg]slows enemies by [yellow]60%[fg] for [yellow]6[fg] seconds on hit"
    end,
    ["saboteur"] = function()
      return "[fg]the explosion has [yellow]50%[fg] chance to crit, increasing in size and dealing [yellow]2x[fg] damage"
    end,
    ["bomber"] = function()
      return "[yellow]+100%[fg] bomb area and damage"
    end,
    ["stormweaver"] = function()
      return "[fg]chain lightning's trigger area of effect and number of units hit is [yellow]doubled"
    end,
    ["sage"] = function()
      return "[fg]when the projectile expires deal [yellow]"
        .. 3 * get_character_stat("sage", 3, "dmg")
        .. "[fg] damage to all enemies under its influence"
    end,
    ["squire"] = function()
      return "[yellow]+30%[fg] damage, attack speed, movement speed and defense to all allies"
    end,
    ["cannoneer"] = function()
      return "[fg]showers the hit area in [yellow]7[fg] additional cannon shots that deal [yellow]"
        .. get_character_stat("cannoneer", 3, "dmg") / 2
        .. "[fg] AoE damage"
    end,
    ["dual_gunner"] = function()
      return "[fg]every 5th attack shoot in rapid succession for [yellow]2[fg] seconds"
    end,
    ["hunter"] = function()
      return "[fg]summons [yellow]3[fg] pets and the pets ricochet off walls once"
    end,
    ["sentry"] = function()
      return "[yellow]+50%[fg] sentry turret attack speed and the projectiles ricochet [yellow]twice[fg]"
    end,
    ["chronomancer"] = function()
      return "[fg]enemies take damage over time [yellow]50%[fg] faster"
    end,
    ["spellblade"] = function()
      return "[fg]faster projectile speed and tighter turns"
    end,
    ["psykeeper"] = function()
      return "[fg]deal [yellow]double[fg] the damage taken by the psykeeper to all enemies"
    end,
    ["engineer"] = function()
      return "[fg]drops [yellow]2[fg] additional turrets and grants all turrets [yellow]+50%[fg] damage and attack speed"
    end,
    ["plague_doctor"] = function()
      return "[fg]nearby enemies take an additional [yellow]"
        .. get_character_stat("plague_doctor", 3, "dmg")
        .. "[fg] damage per second"
    end,
    ["barbarian"] = function()
      return "[fg]stunned enemies also take [yellow]100%[fg] increased damage"
    end,
    ["juggernaut"] = function()
      return "[fg]enemies pushed by the juggernaut take [yellow]"
        .. 4 * get_character_stat("juggernaut", 3, "dmg")
        .. "[fg] damage if they hit a wall"
    end,
    ["lich"] = function()
      return "[fg]chain frost slows enemies hit by [yellow]80%[fg] for [yellow]2[fg] seconds and chains [yellow]+7[fg] times"
    end,
    ["cryomancer"] = function()
      return "[fg]enemies are also slowed by [yellow]60%[fg] while in the area"
    end,
    ["pyromancer"] = function()
      return "[fg]enemies killed by the pyromancer explode, dealing [yellow]"
        .. get_character_stat("pyromancer", 3, "dmg")
        .. "[fg] AoE damage"
    end,
    ["corruptor"] = function()
      return "[fg]spawn [yellow]2[fg] small critters if the corruptor hits an enemy"
    end,
    ["beastmaster"] = function()
      return "[fg]spawn [yellow]4[fg] small critters if the beastmaster gets hit"
    end,
    ["launcher"] = function()
      return "[fg]enemies launched take [yellow]300%[fg] more damage when they hit walls"
    end,
    ["jester"] = function()
      return "[fg]all knives seek enemies and pierce [yellow]2[fg] times"
    end,
    ["assassin"] = function()
      return "[fg]poison inflicted from crits deals [yellow]8x[fg] damage"
    end,
    ["host"] = function()
      return "[fg][yellow]+100%[fg] critter spawn rate and spawn [yellow]2[fg] critters instead"
    end,
    ["carver"] = function()
      return "[fg]carves a tree that creates healing orbs [yellow]twice[fg] as fast"
    end,
    ["bane"] = function()
      return "[yellow]100%[fg] increased area for bane's void rifts"
    end,
    ["psykino"] = function()
      return "[fg]enemies take [yellow]"
        .. 4 * get_character_stat("psykino", 3, "dmg")
        .. "[fg] damage and are pushed away when the area expires"
    end,
    ["barrager"] = function()
      return "[fg]every 3rd attack the barrage shoots [yellow]15[fg] projectiles and they push harder"
    end,
    ["highlander"] = function()
      return "[fg]quickly repeats the attack [yellow]3[fg] times"
    end,
    ["fairy"] = function()
      return "[fg]creates [yellow]2[fg] healing orbs and grants [yellow]2[fg] units [yellow]+100%[fg] attack speed"
    end,
    ["priest"] = function()
      return "[fg]picks [yellow]3[fg] units at random and grants them a buff that prevents death once"
    end,
    ["infestor"] = function()
      return "[fg][yellow]triples[fg] the number of critters released"
    end,
    ["flagellant"] = function()
      return "[yellow]2X[fg] flagellant max HP and grants [yellow]+12%[fg] damage to all allies per cast instead"
    end,
    ["arcanist"] = function()
      return "[yellow]+50%[fg] attack speed for the orb and [yellow]2[fg] projectiles are released per cast"
    end,
    ["illusionist"] = function()
      return "[yellow]doubles[fg] the number of copies created and they release [yellow]12[fg] projectiles on death"
    end,
    ["artificer"] = function()
      return "[fg]automatons shoot and move 50% faster and release [yellow]12[fg] projectiles on death"
    end,
    ["witch"] = function()
      return "[fg]the area releases projectiles, each dealing [yellow]"
        .. get_character_stat("witch", 3, "dmg")
        .. "[fg] damage and chaining once"
    end,
    ["silencer"] = function()
      return "[fg]the curse also deals [yellow]"
        .. get_character_stat("silencer", 3, "dmg")
        .. "[fg] damage per second"
    end,
    ["vulcanist"] = function()
      return "[fg]the number and speed of explosions is [yellow]doubled[fg]"
    end,
    ["warden"] = function()
      return "[fg]creates the force field around [yellow]2[fg] units"
    end,
    ["psychic"] = function()
      return "[fg]the attack can happen from any distance and repeats once"
    end,
    ["miner"] = function()
      return "[fg]release [yellow]8[fg] homing projectiles instead and they pierce twice"
    end,
    ["merchant"] = function()
      return "[fg]your first item reroll is always free"
    end,
    ["usurer"] = function()
      return "[fg]if the same enemy is cursed [yellow]3[fg] times it takes [yellow]"
        .. 10 * get_character_stat("usurer", 3, "dmg")
        .. "[fg] damage"
    end,
    ["gambler"] = function()
      return "[yellow]60/40/20%[fg] chance to cast the attack [yellow]2/3/4[fg] times"
    end,
    ["thief"] = function()
      return "[fg]if the knife crits it deals [yellow]"
        .. 10 * get_character_stat("thief", 3, "dmg")
        .. "[fg] damage, chains [yellow]10[fg] times and grants [yellow]1[fg] gold"
    end,
  }

  character_effect_descriptions_gray = {
    ["vagrant"] = function()
      return "[light_bg]+15% attack speed and damage per active class"
    end,
    ["swordsman"] = function()
      return "[light_bg]the swordsman's damage is doubled"
    end,
    ["wizard"] = function()
      return "[light_bg]the projectile chains 3 times"
    end,
    ["magician"] = function()
      return "[light_bg]+50% attack speed every 12 seconds for 6 seconds"
    end,
    ["archer"] = function()
      return "[light_bg]the arrow ricochets off walls 3 times"
    end,
    ["scout"] = function()
      return "[light_bg]+25% damage per chain and +3 chains"
    end,
    ["cleric"] = function()
      return "[light_bg]creates 4 healing orbs"
    end,
    ["outlaw"] = function()
      return "[light_bg]+50% outlaw attack speed and his knives seek enemies"
    end,
    ["blade"] = function()
      return "[light_bg]deal additional "
        .. math.round(get_character_stat("blade", 3, "dmg") / 2, 2)
        .. " damage per enemy hit"
    end,
    ["elementor"] = function()
      return "[light_bg]slows enemies by 60% for 6 seconds on hit"
    end,
    ["saboteur"] = function()
      return "[light_bg]the explosion has 50% chance to crit, increasing in size and dealing 2x damage"
    end,
    ["bomber"] = function()
      return "[light_bg]+100% bomb area and damage"
    end,
    ["stormweaver"] = function()
      return "[light_bg]chain lightning's trigger area of effect and number of units hit is doubled"
    end,
    ["sage"] = function()
      return "[light_bg]when the projectile expires deal "
        .. 3 * get_character_stat("sage", 3, "dmg")
        .. " damage to all enemies under its influence"
    end,
    ["squire"] = function()
      return "[light_bg]+30% damage, attack speed, movement speed and defense to all allies"
    end,
    ["cannoneer"] = function()
      return "[light_bg]showers the hit area in 7 additional cannon shots that deal "
        .. get_character_stat("cannoneer", 3, "dmg") / 2
        .. " AoE damage"
    end,
    ["dual_gunner"] = function()
      return "[light_bg]every 5th attack shoot in rapid succession for 2 seconds"
    end,
    ["hunter"] = function()
      return "[light_bg]summons 3 pets and the pets ricochet off walls once"
    end,
    ["sentry"] = function()
      return "[light_bg]+50% sentry turret attack speed and the projectiles ricochet twice"
    end,
    ["chronomancer"] = function()
      return "[light_bg]enemies take damage over time 50% faster"
    end,
    ["spellblade"] = function()
      return "[light_bg]faster projectile speed and tighter turns"
    end,
    ["psykeeper"] = function()
      return "[light_bg]deal double the damage taken by the psykeeper to all enemies"
    end,
    ["engineer"] = function()
      return "[light_bg]drops 2 additional turrets and grants all turrets +50% damage and attack speed"
    end,
    ["plague_doctor"] = function()
      return "[light_bg]nearby enemies take an additional "
        .. get_character_stat("plague_doctor", 3, "dmg")
        .. " damage per second"
    end,
    ["barbarian"] = function()
      return "[light_bg]stunned enemies also take 100% increased damage"
    end,
    ["juggernaut"] = function()
      return "[light_bg]enemies pushed by the juggernaut take "
        .. 4 * get_character_stat("juggernaut", 3, "dmg")
        .. " damage if they hit a wall"
    end,
    ["lich"] = function()
      return "[light_bg]chain frost slows enemies hit by 80% for 2 seconds and chains +7 times"
    end,
    ["cryomancer"] = function()
      return "[light_bg]enemies are also slowed by 60% while in the area"
    end,
    ["pyromancer"] = function()
      return "[light_bg]enemies killed by the pyromancer explode, dealing "
        .. get_character_stat("pyromancer", 3, "dmg")
        .. " AoE damage"
    end,
    ["corruptor"] = function()
      return "[light_bg]spawn 2 small critters if the corruptor hits an enemy"
    end,
    ["beastmaster"] = function()
      return "[light_bg]spawn 4 small critters if the beastmaster gets hit"
    end,
    ["launcher"] = function()
      return "[light_bg]enemies launched take 300% more damage when they hit walls"
    end,
    ["jester"] = function()
      return "[light_bg]curses 6 enemies and all knives seek enemies and pierce 2 times"
    end,
    ["assassin"] = function()
      return "[light_bg]poison inflicted from crits deals 8x damage"
    end,
    ["host"] = function()
      return "[light_bg]+100% critter spawn rate and spawn 2 critters instead"
    end,
    ["carver"] = function()
      return "[light_bg]carves a tree that creates healing orbs twice as fast"
    end,
    ["bane"] = function()
      return "[light_bg]100% increased area for bane's void rifts"
    end,
    ["psykino"] = function()
      return "[light_bg]enemies take "
        .. 4 * get_character_stat("psykino", 3, "dmg")
        .. " damage and are pushed away when the area expires"
    end,
    ["barrager"] = function()
      return "[light_bg]every 3rd attack the barrage shoots 15 projectiles and they push harder"
    end,
    ["highlander"] = function()
      return "[light_bg]quickly repeats the attack 3 times"
    end,
    ["fairy"] = function()
      return "[light_bg]creates 2 healing orbs and grants 2 units +100% attack speed"
    end,
    ["priest"] = function()
      return "[light_bg]picks 3 units at random and grants them a buff that prevents death once"
    end,
    ["infestor"] = function()
      return "[light_bg]triples the number of critters released"
    end,
    ["flagellant"] = function()
      return "[light_bg]2X flagellant max HP and grants +12% damage to all allies per cast instead"
    end,
    ["arcanist"] = function()
      return "[light_bg]+50% attack speed for the orb and 2 projectiles are released per cast"
    end,
    ["illusionist"] = function()
      return "[light_bg]doubles the number of copies created and they release 12 projectiles on death"
    end,
    ["artificer"] = function()
      return "[light_bg]automatons shoot and move 50% faster and release 12 projectiles on death"
    end,
    ["witch"] = function()
      return "[light_bg]the area periodically releases projectiles, each dealing "
        .. get_character_stat("witch", 3, "dmg")
        .. " damage and chaining once"
    end,
    ["silencer"] = function()
      return "[light_bg]the curse also deals "
        .. get_character_stat("silencer", 3, "dmg")
        .. " damage per second"
    end,
    ["vulcanist"] = function()
      return "[light_bg]the number and speed of explosions is doubled"
    end,
    ["warden"] = function()
      return "[light_bg]creates the force field around 2 units"
    end,
    ["psychic"] = function()
      return "[light_bg]the attack can happen from any distance and repeats once"
    end,
    ["miner"] = function()
      return "[light_bg]release 8 homing projectiles instead and they pierce twice"
    end,
    ["merchant"] = function()
      return "[light_bg]your first item reroll is always free"
    end,
    ["usurer"] = function()
      return "[light_bg]if the same enemy is cursed 3 times it takes "
        .. 10 * get_character_stat("usurer", 3, "dmg")
        .. " damage"
    end,
    ["gambler"] = function()
      return "[light_bg]60/40/20% chance to cast the attack 2/3/4 times"
    end,
    ["thief"] = function()
      return "[light_bg]if the knife crits it deals "
        .. 10 * get_character_stat("thief", 3, "dmg")
        .. " damage, chains 10 times and grants 1 gold"
    end,
  }

  character_stats = {
    ["vagrant"] = function(lvl)
      return get_character_stat_string("vagrant", lvl)
    end,
    ["swordsman"] = function(lvl)
      return get_character_stat_string("swordsman", lvl)
    end,
    ["wizard"] = function(lvl)
      return get_character_stat_string("wizard", lvl)
    end,
    ["magician"] = function(lvl)
      return get_character_stat_string("magician", lvl)
    end,
    ["archer"] = function(lvl)
      return get_character_stat_string("archer", lvl)
    end,
    ["scout"] = function(lvl)
      return get_character_stat_string("scout", lvl)
    end,
    ["cleric"] = function(lvl)
      return get_character_stat_string("cleric", lvl)
    end,
    ["outlaw"] = function(lvl)
      return get_character_stat_string("outlaw", lvl)
    end,
    ["blade"] = function(lvl)
      return get_character_stat_string("blade", lvl)
    end,
    ["elementor"] = function(lvl)
      return get_character_stat_string("elementor", lvl)
    end,
    ["saboteur"] = function(lvl)
      return get_character_stat_string("saboteur", lvl)
    end,
    ["bomber"] = function(lvl)
      return get_character_stat_string("bomber", lvl)
    end,
    ["stormweaver"] = function(lvl)
      return get_character_stat_string("stormweaver", lvl)
    end,
    ["sage"] = function(lvl)
      return get_character_stat_string("sage", lvl)
    end,
    ["squire"] = function(lvl)
      return get_character_stat_string("squire", lvl)
    end,
    ["cannoneer"] = function(lvl)
      return get_character_stat_string("cannoneer", lvl)
    end,
    ["dual_gunner"] = function(lvl)
      return get_character_stat_string("dual_gunner", lvl)
    end,
    ["hunter"] = function(lvl)
      return get_character_stat_string("hunter", lvl)
    end,
    ["sentry"] = function(lvl)
      return get_character_stat_string("sentry", lvl)
    end,
    ["chronomancer"] = function(lvl)
      return get_character_stat_string("chronomancer", lvl)
    end,
    ["spellblade"] = function(lvl)
      return get_character_stat_string("spellblade", lvl)
    end,
    ["psykeeper"] = function(lvl)
      return get_character_stat_string("psykeeper", lvl)
    end,
    ["engineer"] = function(lvl)
      return get_character_stat_string("engineer", lvl)
    end,
    ["plague_doctor"] = function(lvl)
      return get_character_stat_string("plague_doctor", lvl)
    end,
    ["barbarian"] = function(lvl)
      return get_character_stat_string("barbarian", lvl)
    end,
    ["juggernaut"] = function(lvl)
      return get_character_stat_string("juggernaut", lvl)
    end,
    ["lich"] = function(lvl)
      return get_character_stat_string("lich", lvl)
    end,
    ["cryomancer"] = function(lvl)
      return get_character_stat_string("cryomancer", lvl)
    end,
    ["pyromancer"] = function(lvl)
      return get_character_stat_string("pyromancer", lvl)
    end,
    ["corruptor"] = function(lvl)
      return get_character_stat_string("corruptor", lvl)
    end,
    ["beastmaster"] = function(lvl)
      return get_character_stat_string("beastmaster", lvl)
    end,
    ["launcher"] = function(lvl)
      return get_character_stat_string("launcher", lvl)
    end,
    ["jester"] = function(lvl)
      return get_character_stat_string("jester", lvl)
    end,
    ["assassin"] = function(lvl)
      return get_character_stat_string("assassin", lvl)
    end,
    ["host"] = function(lvl)
      return get_character_stat_string("host", lvl)
    end,
    ["carver"] = function(lvl)
      return get_character_stat_string("carver", lvl)
    end,
    ["bane"] = function(lvl)
      return get_character_stat_string("bane", lvl)
    end,
    ["psykino"] = function(lvl)
      return get_character_stat_string("psykino", lvl)
    end,
    ["barrager"] = function(lvl)
      return get_character_stat_string("barrager", lvl)
    end,
    ["highlander"] = function(lvl)
      return get_character_stat_string("highlander", lvl)
    end,
    ["fairy"] = function(lvl)
      return get_character_stat_string("fairy", lvl)
    end,
    ["priest"] = function(lvl)
      return get_character_stat_string("priest", lvl)
    end,
    ["infestor"] = function(lvl)
      return get_character_stat_string("infestor", lvl)
    end,
    ["flagellant"] = function(lvl)
      return get_character_stat_string("flagellant", lvl)
    end,
    ["arcanist"] = function(lvl)
      return get_character_stat_string("arcanist", lvl)
    end,
    ["illusionist"] = function(lvl)
      return get_character_stat_string("illusionist", lvl)
    end,
    ["artificer"] = function(lvl)
      return get_character_stat_string("artificer", lvl)
    end,
    ["witch"] = function(lvl)
      return get_character_stat_string("witch", lvl)
    end,
    ["silencer"] = function(lvl)
      return get_character_stat_string("silencer", lvl)
    end,
    ["vulcanist"] = function(lvl)
      return get_character_stat_string("vulcanist", lvl)
    end,
    ["warden"] = function(lvl)
      return get_character_stat_string("warden", lvl)
    end,
    ["psychic"] = function(lvl)
      return get_character_stat_string("psychic", lvl)
    end,
    ["miner"] = function(lvl)
      return get_character_stat_string("miner", lvl)
    end,
    ["merchant"] = function(lvl)
      return get_character_stat_string("merchant", lvl)
    end,
    ["usurer"] = function(lvl)
      return get_character_stat_string("usurer", lvl)
    end,
    ["gambler"] = function(lvl)
      return get_character_stat_string("gambler", lvl)
    end,
    ["thief"] = function(lvl)
      return get_character_stat_string("thief", lvl)
    end,
  }
  ...
  class_descriptions = {
    ["ranger"] = function(lvl)
      return "["
        ...
        .. "]8%[light_bg]/["
        .. ylb2(lvl)
        .. "]16% [fg]chance to release a barrage on attack to allied rangers"
    end,
    ["warrior"] = function(lvl)
      return "["
        ...
        .. "]+25[light_bg]/["
        .. ylb2(lvl)
        .. "]+50 [fg]defense to allied warriors"
    end,
    ["mage"] = function(lvl)
      return "["
        .. ylb1(lvl)
    ...
    ["rogue"] = function(lvl)
      return "["
        ...
        .. "]15%[light_bg]/["
        .. ylb2(lvl)
        .. "]30% [fg]chance to crit to allied rogues, dealing [yellow]4x[] damage"
    end,
    ["healer"] = function(lvl)
      return "["
        .. ylb1(lvl)
        ...
        .. "]+15%[light_bg]/["
        .. ylb2(lvl)
        .. "]+30% [fg] chance to create [yellow]+1[fg] healing orb on healing orb creation"
    end,
    ["enchanter"] = function(lvl)
      return "["
        .. ylb1(lvl)
        .. "]2[light_bg]/["
        .. ylb2(lvl)
    ...
    ["nuker"] = function(lvl)
      return "["
        ...
        .. "]+15%[light_bg]/["
        .. ylb2(lvl)
        .. "]+25% [fg]area damage and size to allied nukers"
    end,
    ["conjurer"] = function(lvl)
      return "["
        .. ylb1(lvl)
        .. "]2[light_bg]/["
        .. ylb2(lvl)
        ...
        .. "]+25%[light_bg]/["
        .. ylb2(lvl)
        .. "]+50% [fg]construct damage and duration"
    end,
    ["psyker"] = function(lvl)
      return "["
        .. ylb1(lvl)
        ...
        .. "]+2[light_bg]/["
        .. ylb2(lvl)
        .. "]+4 [fg]total psyker orbs and [yellow]+1[fg] orb for each psyker"
    end,
    ["curser"] = function(lvl)
      return "["
        .. ylb1(lvl)
        ...
        .. "]+1[light_bg]/["
        .. ylb2(lvl)
        .. "]+3 [fg]max curse targets to allied cursers"
    end,
    ["forcer"] = function(lvl)
      return "["
        .. ylb1(lvl)
        ...
        .. "]+25%[light_bg]/["
        .. ylb2(lvl)
        .. "]+50% [fg]knockback force to all allies"
    end,
    ["swarmer"] = function(lvl)
      return "["
        .. ylb1(lvl)
        .. "]2[light_bg]/["
        .. ylb2(lvl)
    ...
    ["voider"] = function(lvl)
      return "["
        ...
        .. "]+20%[light_bg]/["
        .. ylb2(lvl)
        .. "]+40% [fg]damage over time to allied voiders"
    end,
    ["sorcerer"] = function(lvl)
      return "["
        ...
        .. "]4[light_bg]/["
        .. ylb3(lvl)
        .. "]6 [fg]- sorcerers repeat their attacks once every ["
        .. ylb1(lvl)
        .. "]4[light_bg]/["
        .. ylb2(lvl)
        .. "]3[light_bg]/["
    ...
    ["mercenary"] = function(lvl)
      return "["
        ...
        .. "]+8%[light_bg]/["
        .. ylb2(lvl)
        .. "]+16% [fg]chance for enemies to drop gold on death"
    end,
    ["explorer"] = function(lvl)
      return "[yellow]+15%[fg] attack speed and damage per active class to allied explorers"
    end,
  }
  ...
  launches_projectiles = function(character)
    ...
    return table.any(classes, function(v)
      return v == character
    end)
  end
  ...
  get_number_of_units_per_class = function(units)
    ...
    for _, unit in ipairs(units) do
      for _, unit_class in ipairs(character_classes[unit.character]) do
        if unit_class == "ranger" then
          rangers = rangers + 1
        end
        if unit_class == "warrior" then
          warriors = warriors + 1
        end
        if unit_class == "healer" then
          healers = healers + 1
        end
        if unit_class == "mage" then
          mages = mages + 1
        end
        if unit_class == "nuker" then
          nukers = nukers + 1
        end
        if unit_class == "conjurer" then
          conjurers = conjurers + 1
        end
        if unit_class == "rogue" then
          rogues = rogues + 1
        end
        if unit_class == "enchanter" then
          enchanters = enchanters + 1
        end
        if unit_class == "psyker" then
          psykers = psykers + 1
        end
        if unit_class == "curser" then
          cursers = cursers + 1
        end
        if unit_class == "forcer" then
          forcers = forcers + 1
        end
        if unit_class == "swarmer" then
          swarmers = swarmers + 1
        end
        if unit_class == "voider" then
          voiders = voiders + 1
        end
        if unit_class == "sorcerer" then
          sorcerers = sorcerers + 1
        end
        if unit_class == "mercenary" then
          mercenaries = mercenaries + 1
        end
        if unit_class == "explorer" then
  ...
  get_class_levels = function(units)
    ...
    local units_to_class_level = function(number_of_units, class)
      if
        ...
        or class == "rogue"
      then
        if number_of_units >= 6 then
          return 2
        elseif number_of_units >= 3 then
          return 1
        else
          return 0
        end
      elseif
        ...
        or class == "psyker"
      then
        if number_of_units >= 4 then
          return 2
        elseif number_of_units >= 2 then
          return 1
        else
          return 0
        end
  ...
  class_set_numbers = {
    ["ranger"] = function(units)
      return 3, 6, nil, get_number_of_units_per_class(units).ranger
    end,
    ["warrior"] = function(units)
      return 3, 6, nil, get_number_of_units_per_class(units).warrior
    end,
    ["mage"] = function(units)
      return 3, 6, nil, get_number_of_units_per_class(units).mage
    end,
    ["nuker"] = function(units)
      return 3, 6, nil, get_number_of_units_per_class(units).nuker
    end,
    ["rogue"] = function(units)
      return 3, 6, nil, get_number_of_units_per_class(units).rogue
    end,
    ["healer"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).healer
    end,
    ["conjurer"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).conjurer
    end,
    ["enchanter"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).enchanter
    end,
    ["psyker"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).psyker
    end,
    ["curser"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).curser
    end,
    ["forcer"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).forcer
    end,
    ["swarmer"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).swarmer
    end,
    ["voider"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).voider
    end,
    ["sorcerer"] = function(units)
      return 2, 4, 6, get_number_of_units_per_class(units).sorcerer
    end,
    ["mercenary"] = function(units)
      return 2, 4, nil, get_number_of_units_per_class(units).mercenary
    end,
    ["explorer"] = function(units)
      return 1, 1, nil, get_number_of_units_per_class(units).explorer
    end,
  }
  ...
  passive_descriptions_level = {
    ["centipede"] = function(lvl)
      return ts(lvl, "+10%", "20%", "30%") .. " movement speed"
    end,
    ["ouroboros_technique_r"] = function(lvl)
      return "[fg]rotating around yourself to the right releases "
        .. ts(lvl, "2", "3", "4")
        .. " projectiles per second"
    end,
    ["ouroboros_technique_l"] = function(lvl)
      return "[fg]rotating around yourself to the left grants "
        .. ts(lvl, "+15%", "25%", "35%")
        .. " defense to all units"
    end,
    ["amplify"] = function(lvl)
      return ts(lvl, "+20%", "35%", "50%") .. " AoE damage"
    end,
    ["resonance"] = function(lvl)
      return "[fg]all AoE attacks deal " .. ts(lvl, "+3%", "5%", "7%") .. " damage per unit hit"
    end,
    ["ballista"] = function(lvl)
      return ts(lvl, "+20%", "35%", "50%") .. " projectile damage"
    end,
    ["call_of_the_void"] = function(lvl)
      return ts(lvl, "+30%", "60%", "90%") .. " DoT damage"
    end,
    ["crucio"] = function(lvl)
      return "[fg]taking damage also shares that across all enemies at "
        .. ts(lvl, "20%", "30%", "40%")
        .. " its value"
    end,
    ["speed_3"] = function(lvl)
      return "[fg]position [yellow]3[fg] has [yellow]+50%[fg] attack speed"
    end,
    ["damage_4"] = function(lvl)
      return "[fg]position [yellow]4[fg] has [yellow]+30%[fg] damage"
    end,
    ["shoot_5"] = function(lvl)
      return "[fg]position [yellow]5[fg] shoots [yellow]3[fg] projectiles per second"
    end,
    ["death_6"] = function(lvl)
      return "[fg]position [yellow]6[fg] takes [yellow]10%[fg] of its health as damage every [yellow]3[fg] seconds"
    end,
    ["lasting_7"] = function(lvl)
      return "[fg]position [yellow]7[fg] will stay alive for [yellow]10[fg] seconds after dying"
    end,
    ["defensive_stance"] = function(lvl)
      return "[fg]first and last positions have " .. ts(lvl, "+10%", "20%", "30%") .. " defense"
    end,
    ["offensive_stance"] = function(lvl)
      return "[fg]first and last positions have " .. ts(lvl, "+10%", "20%", "30%") .. " damage"
    end,
    ["kinetic_bomb"] = function(lvl)
      return "[fg]when an ally dies it explodes, launching enemies away"
    end,
    ["porcupine_technique"] = function(lvl)
      return "[fg]when an ally dies it explodes, releasing piercing projectiles"
    end,
    ["last_stand"] = function(lvl)
      return "[fg]the last unit alive is fully healed and receives a [yellow]+20%[fg] bonus to all stats"
    end,
    ["seeping"] = function(lvl)
      return "[fg]enemies taking DoT damage have " .. ts(lvl, "-15%", "25%", "35%") .. " defense"
    end,
    ["deceleration"] = function(lvl)
      return "[fg]enemies taking DoT damage have "
        .. ts(lvl, "-15%", "25%", "35%")
        .. " movement speed"
    end,
    ["annihilation"] = function(lvl)
      return "[fg]when a voider dies deal its DoT damage to all enemies for [yellow]3[fg] seconds"
    end,
    ["malediction"] = function(lvl)
      return ts(lvl, "+1", "3", "5") .. " max curse targets to all allied cursers"
    end,
    ["hextouch"] = function(lvl)
      return "[fg]enemies take "
        .. ts(lvl, "10", "15", "20")
        .. "damage per second for [yellow]3[fg] seconds when cursed"
    end,
    ["whispers_of_doom"] = function(lvl)
      return "[fg]curses apply doom, deal "
        .. ts(lvl, "100", "150", "200")
        .. " every "
        .. ts(lvl, "4", "3", "2")
        .. " doom instances"
    ...
    ["tremor"] = function(lvl)
      return "[fg]when enemies hit walls they create an area based to the knockback force"
    end,
    ["heavy_impact"] = function(lvl)
      return "[fg]when enemies hit walls they take damage based on the knockback force"
    end,
    ["fracture"] = function(lvl)
      return "[fg]when enemies hit walls they explode into projectiles"
    end,
    ["meat_shield"] = function(lvl)
      return "[fg]critters [yellow]block[fg] enemy projectiles"
    end,
    ["hive"] = function(lvl)
      return "[fg]critters have " .. ts(lvl, "+1", "2", "3") .. " HP"
    end,
    ["baneling_burst"] = function(lvl)
      return "[fg]critters die immediately on contact but also deal "
        .. ts(lvl, "50", "100", "150")
        .. " AoE damage"
    end,
    ["blunt_arrow"] = function(lvl)
      return "[fg]ranger arrows have " .. ts(lvl, "+10%", "20%", "30%") .. " chance to knockback"
    end,
    ["explosive_arrow"] = function(lvl)
      return "[fg]ranger arrows have "
        .. ts(lvl, "+10%", "20%", "30%")
        .. " chance to deal "
        .. ts(lvl, "10%", "20%", "30%")
        .. " AoE damage"
    end,
    ["divine_machine_arrow"] = function(lvl)
      return "[fg]ranger arrows have a "
        .. ts(lvl, "10%", "20%", "30%")
        .. " chance to seek and pierce "
        .. ts(lvl, "1", "2", "3")
        .. " times"
    end,
    ["chronomancy"] = function(lvl)
      return "[fg]mages cast their spells " .. ts(lvl, "15%", "25%", "35%") .. " faster"
    end,
    ["awakening"] = function(lvl)
      return ts(lvl, "+50%", "75%", "100%")
        .. " attack speed and damage to [yellow]1[fg] mage every round for that round"
    end,
    ["divine_punishment"] = function(lvl)
      return "[fg]deal damage to all enemies based on how many mages you have"
    end,
    ["assassination"] = function(lvl)
      return "[fg]crits from rogues deal "
        .. ts(lvl, "8x", "10x", "12x")
        .. " damage but normal attacks deal [yellow]half[fg] damage"
    end,
    ["flying_daggers"] = function(lvl)
      return "[fg]all projectiles thrown by rogues chain " .. ts(lvl, "+2", "3", "4") .. " times"
    end,
    ["ultimatum"] = function(lvl)
      return "[fg]projectiles that chain gain "
        .. ts(lvl, "+10%", "20%", "30%")
        .. " damage with each chain"
    end,
    ["magnify"] = function(lvl)
      return ts(lvl, "+20%", "35%", "50%") .. " area size"
    end,
    ["echo_barrage"] = function(lvl)
      return ts(lvl, "10%", "20%", "30%")
        .. " chance to create "
        .. ts(lvl, "1", "2", "3")
        .. " secondary AoEs on AoE hit"
    end,
    ["unleash"] = function(lvl)
      return "[fg]all nukers gain [yellow]+1%[fg] area size and damage every second"
    end,
    ["reinforce"] = function(lvl)
      return ts(lvl, "+10%", "20%", "30%")
        .. " global damage, defense and aspd if you have one or more enchanters"
    end,
    ["payback"] = function(lvl)
      return ts(lvl, "+2%", "5%", "8%") .. " damage to all allies whenever an enchanter is hit"
    end,
    ["enchanted"] = function(lvl)
      return ts(lvl, "+33%", "66%", "99%")
        .. " attack speed to a random unit if you have two or more enchanters"
    end,
    ["freezing_field"] = function(lvl)
      return "[fg]creates an area that slows enemies by [yellow]50%[fg] for [yellow]2[fg] seconds on sorcerer spell repeat"
    end,
    ["burning_field"] = function(lvl)
      return "[fg]creates an area that deals [yellow]30[fg] dps for [yellow]2[fg] seconds on sorcerer spell repeat"
    end,
    ["gravity_field"] = function(lvl)
      return "[fg]creates an area that pulls enemies in for [yellow]1[fg] seconds on sorcerer spell repeat"
    end,
    ["magnetism"] = function(lvl)
      return "[fg]gold coins and healing orbs are attracted to the snake from a longer range"
    end,
    ["insurance"] = function(lvl)
      return "[fg]heroes have [yellow]4[fg] times the chance of mercenary's bonus to drop [yellow]2[fg] gold on death"
    end,
    ["dividends"] = function(lvl)
      return "[fg]mercenaries deal [yellow]+X%[fg] damage, where X is how much gold you have"
    end,
    ["berserking"] = function(lvl)
      return "[fg]all warriors have up to "
        .. ts(lvl, "+50%", "75%", "100%")
        .. " attack speed based on missing HP"
    end,
    ["unwavering_stance"] = function(lvl)
      return "[fg]all warriors gain "
        .. ts(lvl, "+4%", "8%", "12%")
        .. " defense every [yellow]5[fg] seconds"
    end,
    ["unrelenting_stance"] = function(lvl)
      return ts(lvl, "+2%", "5%", "8%") .. " defense to all allies whenever a warrior is hit"
    end,
    ["blessing"] = function(lvl)
      return ts(lvl, "+10%", "20%", "30%") .. " healing effectiveness"
    end,
    ["haste"] = function(lvl)
      return "[yellow]+50%[fg] movement speed that decays over [yellow]4[fg] seconds on healing orb pick up"
    end,
    ["divine_barrage"] = function(lvl)
      return ts(lvl, "20%", "40%", "60%")
        .. " chance to release a ricocheting barrage on healing orb pick up"
    end,
    ["orbitism"] = function(lvl)
      return ts(lvl, "+25%", "50%", "75%") .. " psyker orb movement speed"
    end,
    ["psyker_orbs"] = function(lvl)
      return ts(lvl, "+1", "2", "4") .. " psyker orbs"
    end,
    ["psychosense"] = function(lvl)
      return ts(lvl, "+33%", "66%", "99%") .. " orb range"
    end,
    ["psychosink"] = function(lvl)
      return "[fg]psyker orbs deal " .. ts(lvl, "+40%", "80%", "120%") .. " damage"
    end,
    ["rearm"] = function(lvl)
      return "[fg]constructs repeat their attacks once"
    end,
    ["taunt"] = function(lvl)
      return ts(lvl, "10%", "20%", "30%")
        .. " chance for constructs to taunt nearby enemies on attack"
    end,
    ["construct_instability"] = function(lvl)
      return "[fg]constructs explode when disappearing, dealing "
        .. ts(lvl, "100", "150", "200%")
        .. " damage"
    end,
    ["intimidation"] = function(lvl)
      return "[fg]enemies spawn with " .. ts(lvl, "-10", "20", "30%") .. " max HP"
    end,
    ["vulnerability"] = function(lvl)
      return "[fg]enemies take " .. ts(lvl, "+10", "20", "30%") .. " damage"
    end,
    ["temporal_chains"] = function(lvl)
      return "[fg]enemies are " .. ts(lvl, "10", "20", "30%") .. " slower"
    end,
    ["ceremonial_dagger"] = function(lvl)
      return "[fg]killing an enemy fires a homing dagger"
    end,
    ["homing_barrage"] = function(lvl)
      return ts(lvl, "8", "16", "24%") .. " chance to release a homing barrage on enemy kill"
    end,
    ["critical_strike"] = function(lvl)
      return ts(lvl, "5", "10", "15%")
        .. " chance for attacks to critically strike, dealing [yellow]2x[fg] damage"
    end,
    ["noxious_strike"] = function(lvl)
      return ts(lvl, "8", "16", "24%")
        .. " chance for attacks to poison, dealing [yellow]20%[fg] dps for [yellow]3[fg] seconds"
    end,
    ["infesting_strike"] = function(lvl)
      return ts(lvl, "10", "20", "30%")
        .. " chance for attacks to spawn [yellow]2[fg] critters on kill"
    end,
    ["kinetic_strike"] = function(lvl)
      return ts(lvl, "10", "20", "30%")
        .. " chance for attacks to push enemies away with high force"
    end,
    ["burning_strike"] = function(lvl)
      return "[yellow]15%[fg] chance for attacks to burn, dealing [yellow]20%[fg] dps for [yellow]3[fg] seconds"
    end,
    ["lucky_strike"] = function(lvl)
      return "[yellow]8%[fg] chance for attacks to cause enemies to drop gold on death"
    end,
    ["healing_strike"] = function(lvl)
      return "[yellow]8%[fg] chance for attacks to spawn a healing orb on kill"
    end,
    ["stunning_strike"] = function(lvl)
      return ts(lvl, "8", "16", "24%") .. " chance for attacks to stun for [yellow]2[fg] seconds"
    end,
    ["silencing_strike"] = function(lvl)
      return ts(lvl, "8", "16", "24%")
        .. " chance for attacks to silence for [yellow]2[fg] seconds on hit"
    end,
    ["warping_shots"] = function(lvl)
      return "projectiles ignore wall collisions and warp around the screen "
        .. ts(lvl, "1", "2", "3")
        .. " times"
    end,
    ["culling_strike"] = function(lvl)
      return "[fg]instantly kill elites below " .. ts(lvl, "10", "20", "30%") .. " max HP"
    end,
    ["lightning_strike"] = function(lvl)
      return ts(lvl, "5", "10", "15%")
        .. " chance for projectiles to create chain lightning, dealing "
        .. ts(lvl, "60", "80", "100%")
        .. " damage"
    end,
    ["psycholeak"] = function(lvl)
      return "[fg]position [yellow]1[fg] generates [yellow]1[fg] psyker orb every [yellow]10[fg] seconds"
    end,
    ["divine_blessing"] = function(lvl)
      return "[fg]generate [yellow]1[fg] healing orb every [yellow]8[fg] seconds"
    end,
    ["hardening"] = function(lvl)
      return "[yellow]+150%[fg] defense to all allies for [yellow]3[fg] seconds after an ally dies"
    end,
  }
  ...
  if not state.current_new_game_plus then
    state.current_new_game_plus = current_new_game_plus
  end
  max_units = math.clamp(7 + current_new_game_plus, 7, 12)

  main_song_instance =
    _G[random:table({ "song1", "song2", "song3", "song4", "song5" })]:play({ volume = 0.5 })
  main = Main()
  ...
  trigger:tween(0.25, _G, { slow_amount = 0 }, math.linear, function()
    ...
    if self:is(Arena) then
      self.paused_t1 = Text2({
        ...
        sy = 0.6,
        lines = {
          { text = "[bg10]<-, a or m1       ->, d or m2", font = fat_font, alignment = "center" },
        },
      })
    ...
    if self:is(MainMenu) then
      self.ng_t = Text2({
        ...
        lines = {
          {
            text = "[bg10]current: " .. current_new_game_plus,
            font = pixul_font,
            alignment = "center",
          },
        },
    ...
    self.resume_button = Button({
      ...
      y = gh - 225,
      force_update = true,
      button_text = self:is(MainMenu) and "main menu (esc)" or "resume game (esc)",
      fg_color = "bg10",
      bg_color = "bg",
      action = function(b)
    ...
    self.run_timer_button = Button({
      ...
      y = gh - 150,
      force_update = true,
      button_text = "run timer: " .. tostring(state.run_timer and "yes" or "no"),
      fg_color = "bg10",
      bg_color = "bg",
      action = function(b)
        ui_switch1:play({ pitch = random:float(0.95, 1.05), volume = 0.5 })
    ...
    self.cooldown_snake_button = Button({
      group = self.ui,
      x = gw / 2 + 75,
      y = gh - 100,
      w = 145,
      force_update = true,
      button_text = "[bg10]cooldowns on snake: "
        .. tostring(state.cooldown_snake and "yes" or "no"),
      fg_color = "bg10",
      bg_color = "bg",
      action = function(b)
        ui_switch1:play({ pitch = random:float(0.95, 1.05), volume = 0.5 })
    ...
    self.arrow_snake_button = Button({
      ...
      w = 125,
      force_update = true,
      button_text = "[bg10]arrow on snake: " .. tostring(state.arrow_snake and "yes" or "no"),
      fg_color = "bg10",
      bg_color = "bg",
      action = function(b)
        ui_switch1:play({ pitch = random:float(0.95, 1.05), volume = 0.5 })
    ...
    self.screen_movement_button = Button({
      ...
      w = 135,
      force_update = true,
      button_text = "[bg10]screen movement: "
        .. tostring(state.no_screen_movement and "no" or "yes"),
      fg_color = "bg10",
      bg_color = "bg",
      action = function(b)
        ui_switch1:play({ pitch = random:float(0.95, 1.05), volume = 0.5 })
    ...
    if self:is(MainMenu) then
      self.ng_plus_minus_button = Button({
        group = self.ui,
        x = gw / 2 - 58,
        y = gh - 50,
        force_update = true,
      ...
      self.ng_plus_plus_button = Button({
        group = self.ui,
        x = gw / 2 + 5,
        y = gh - 50,
        force_update = true,
