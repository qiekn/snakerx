...
function math.elastic_in(t)
  ...
  elseif t == 1 then
    ...
    return -(
      amplitude
      * math.exp(LN210 * t)
      * math.sin((t * 0.001 - period / 4) * (2 * PI) / period)
    )
  end
end
...
function math.elastic_in_out(t)
  ...
  elseif t == 1 then
    ...
    if t < 1 then
      ...
      t = t - 1
      return amplitude * math.exp(-LN210 * t) * math.sin(
        (t * 0.001 - period / 4) * (2 * PI) / period
      ) * 0.5 + 1
    end
  end
end
...
function math.elastic_out_in(t)
  if t < 0.5 then
    ...
    if t == 0 then
      ...
      return (amplitude / 2) * math.exp(-LN210 * t) * math.sin(
        (t * 0.001 - period / 4) * (2 * PI) / period
      ) + 0.5
    end
  else
